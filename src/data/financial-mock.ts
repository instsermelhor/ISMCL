...
export const bankIntegrations: BankIntegration[] = [
  ...
  { id: 'bank6', bankId: 'inter', bankName: 'Banco Inter', bankLogo: '🟠', countryCode: 'BR', type: 'PIX', currency: 'BRL', status: 'DISCONNECTED', environment: 'sandbox' },
  { id: 'bank7', bankId: 'efi', bankName: 'Efí Bank (ex-Gerencianet)', bankLogo: '💚', countryCode: 'BR', type: 'PIX', currency: 'BRL', status: 'DISCONNECTED', environment: 'sandbox' },
  { id: 'bank8', bankId: 'stripe', bankName: 'Stripe', bankLogo: '💜', countryCode: 'US', type: 'GATEWAY', currency: 'USD', status: 'DISCONNECTED', environment: 'sandbox' },
  { id: 'bank9', bankId: 'paypal', bankName: 'PayPal', bankLogo: '🔷', countryCode: 'US', type: 'GATEWAY', currency: 'USD', status: 'DISCONNECTED', environment: 'sandbox' },
  { id: 'bank10', bankId: 'wise', bankName: 'Wise (Transferência Internacional)', bankLogo: '🌍', countryCode: 'INT', type: 'INTERNATIONAL', currency: 'EUR', status: 'DISCONNECTED', environment: 'sandbox' },
];

// ─── PROJETOS & PROGRAMAS DA PLATAFORMA ──────────────────────
export interface PlatformProject {
  id: string;
  name: string;
  shortName: string;
  description: string;
  category: 'SAUDE_MENTAL' | 'PROTECAO' | 'IDOSO' | 'INFANCIA' | 'INCLUSAO' | 'TECNOLOGIA' | 'CAPACITACAO';
  icon: string;
  color: string;
  goalAmount: number;
  raisedAmount: number;
