...
export const MOCK_IAM_USERS: IAMUser[] = [
  {
    ...
    initials: 'SA',
    roles: ['super_admin', 'super_user_universal'],
    primaryRole: 'super_admin',
    permissions: buildPermissions(['super_admin', 'super_user_universal']),
    status: 'active',
...
export const USER_CREDENTIALS: Record<string, { password: string; userId: string }> = {
  'aurainstitutosermelhor@gmail.com': { password: 'Aura@2026!FirstAccess', userId: 'usr-001' },
