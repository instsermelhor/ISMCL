...
export const adaptiveQuestions: AdaptiveQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'Polícia Rodoviária Federal', value: 'prf' },
      { label: 'Polícia Penal', value: 'pp' },
      { label: 'Guarda Civil Municipal', value: 'gcm' },
      { label: 'Corpo de Bombeiros Militar', value: 'cb' },
      { label: 'Forças Armadas (Exército, Marinha, Aeronáutica)', value: 'fa' },
      { label: 'Outra instituição pública de segurança', value: 'other' },
    ],
  ...
  },
  {
    id: 'functional_id',
    step: 1,
    label: 'Número Funcional (matrícula/RE)',
    description: 'Informe sua matrícula ou Registro de Efetivo (RE) institucional.',
    privacyNote: 'Este dado ativará a proteção reforçada do Cofre Digital AURA. Será mascarado e protegido por controles adicionais de acesso e auditoria.',
    type: 'text',
    required: true,
    showIf: { questionId: 'is_security_forces', operator: 'equals', value: 'yes' },
    triggersAction: [
